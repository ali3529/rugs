...
function AddressForm({ createdAdress }) {
    const { createAddress } = useProductsApis()
    ...
    const addAddress = useMutation(async (address) => createAddress(address), {
        onSuccess: (res) => {
    ...
    const submitAdress = (e) => {
        e.preventDefault();
        const adressData = { address1: [address], city, country, country_name, phone, postcode, state }
        console.log("saasvc", adressData);
        addAddress.mutate(adressData)
    }
    ...
    return (
        <form className='p-2' onSubmit={(e) => submitAdress(e)}>
            ...
            <div className='flex justify-center'>
                ...
                >
                    {
                        addAddress.isLoading ? <div className='flex justify-center'>
