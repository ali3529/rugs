...
function Search() {
    ...
    return (
        <div className='flex flex-col '>
            <div className="w-full mx-2  md:-px-4 lg:-px-0 md:flex hidden  flex-row items-center">
                <Input
                    placeholder="Search"
                    className="border-indigo-400 border rounded-md px-4 py-1 w-full shadow-none "
            ...
            </div>
            {
                ...
                <Transition
                    ...
                    //     setshowSuggest(false)
                    // }, 5000)}
                    className='z-40  bg-white rounded-xl grid grid-cols-1 w-full lg:-ml-0 -ml-16 '
                >

                    {/* <div onMouseDown={(e) => setshowSuggest(false)}> */}
                    <div ref={wrapperRef} >
                        <div className="px-1 w-3/6  z-50 absolute top-14  bg-white py-1   " >
                            <div className='flex flex-col'>
